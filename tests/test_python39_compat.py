...
MRSG_RUNTIME_PATHS = (
    ...
    + (
        ...
        Path("anaprior/features/afloc_official_heatmap.py"),
        Path("anaprior/eval/eval_mscxr_afloc_official_anchor.py"),
        Path("anaprior/eval/report_afloc_official_anchor_parity.py"),
